...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.greenhouse("kubejs:greenhouse_ender_spore")
        .circuit(2)
        .notConsumable("kubejs:ender_spore")
        .itemInputs("2x gtceu:fertilizer")
    ...
    event.recipes.gtceu.greenhouse("kubejs:greenhouse_boosted_ender_spore")
        ...
        .duration(640)
        .EUt(120)
    event.recipes.gtceu.greenhouse("kubejs:greenhouse_glow_shroom")
        .circuit(2)
